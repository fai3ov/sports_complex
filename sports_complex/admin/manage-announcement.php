...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Главная страница</a><a href="announcement.php">Объявления</a> <a href="manage-announcement.php" class="current">Управление объявлениями</a> </div>
    <h1 class="text-center">Управление объявлениями <i class="fas fa-bullhorn"></i></h1>
  </div>
        ...
        $result=mysqli_query($conn,$qry);
          ...
          echo"<table class='table table-bordered table-hover'>
            ...
            echo"<tbody> 
                ...
                <td><div class='text-center'><a href='actions/remove-announcement.php?id=".$row['id']."' style='color:#F66;' ><i class='fas fa-trash'></i> Удалить</a></div></td>

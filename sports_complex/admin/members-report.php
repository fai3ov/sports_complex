...
<div id="content">
  <div id="content-header">
    ...
    <h1 class="text-center">Отчёты о клиентах <i class="fas fa-file"></i></h1>
  </div>
        ...
        $result=mysqli_query($conn,$qry);
          ...
          echo"<table class='table table-bordered table-hover'>
           ...
           <tbody> 
                ...
                <td><div class='text-center'><a href="view-member-report.php?id= <?php echo $row['user_id'] ?>"><i class="fas fa-file"></i> Посмотреть отчёт</a></div></td>

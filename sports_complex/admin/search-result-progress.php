...
<div id="content">
  <div id="content-header">
      <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Главная страница</a> <a href="customer-progress.php" class="current">Прогресс клиентов</a> </div>
      <h1 class="text-center">Обновить прогресс клиента <i class="fas fa-signal"></i></h1>
  </div>
        ...
        <thead>
          <tr>
            ...
            echo"<tbody> 
                ...
                <td><div class='text-center'><a href='update-progress.php?id=".$row['user_id']."'><button class='btn btn-warning btn-mini'> Обновить прогресс</button></a></div></td>

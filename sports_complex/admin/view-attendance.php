...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Главная страница</a> <a href="view-attendance.php" class="current">Просмотр посещений</a> </div>
    <h1 class="text-center">Список посещений клиентов <i class="fas fa-calendar"></i></h1>
  </div>

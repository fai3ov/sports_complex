...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Главная страница</a> <a href="payment.php">Платежи от клиентов</a> <a class="current">Счёт на оплату</a> </div>
    <h1>Форма оплаты</h1>
  </div>

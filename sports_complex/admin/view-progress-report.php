...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Главная страница</a> <a href="member-report.php" class="current">Отчёты о прогрессе клиентов</a> </div>
    <h1 class="text-center">Отчёт о прогрессе клиента <i class="fas fa-tasks"></i></h1>
  </div>
    ...
    <div class="row-fluid">
     ...
     <div class="widget-content">
            <div class="row-fluid">
              ...
              <div class="span8">
                <table class="table table-bordered table-invoice-full">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><div class="text-center"><?php echo $row['ini_weight']; ?> кг</div></td>
                      <td><div class="text-center"><?php echo $row['curr_weight']; ?> кг</div></td>
                ...
                <table class="table table-bordered table-invoice-full">
                  <tbody>
                    <tr>
                      <td class="msg-invoice" width="55%"> <div class="text-center"><h5>Телосложение : <?php echo $row['ini_bodytype']; ?> → <?php echo $row['curr_bodytype']; ?><br /> Изменение веса : <?php include 'actions/weight-diff.php';?> кг <br /> — по данным от <?php echo $row['progress_date']; ?> —</h5>
                        </div>
                    </tr>
                  </tbody>
                </table>
            ...
            <div class="row-fluid">
                <div class="pull-left">
                <br>
                <h4>Клиент : <?php echo $row['fullname']; ?> <br> Изменение веса составило <em style="color:green"><?php include 'actions/progress-percent.php';?>%</em> согласно текущим показателям. <i class="fa fa-spinner fa-spin" style="font-size:24px"></i><br/> <br/>  <br/></h4><p>Спасибо, что выбрали нас!<br/>С уважением, команда спорткомплекса.</p>
                </div>

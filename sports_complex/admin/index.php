...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"><a href="index.php" title="Вы уже находитесь здесь!" class="tip-bottom"><i class="fa fa-home"></i>
    ...
    <div class="container-fluid">
        <div class="quick-actions_homepage">
            <ul class="quick-actions">
                <li class="bg_ls span"><a href="index.php" style="font-size: 16px;"> <i class="fas fa-user-check"></i>
                        <span class="label label-important"><?php include 'actions/dashboard-activecount.php' ?></span>
                        Активные клиенты</a></li>
                <li class="bg_lo span3"><a href="members.php" style="font-size: 16px;"> <i class="fas fa-users"></i></i>
                        <span class="label label-important"><?php include 'dashboard-usercount.php' ?></span>
                        Зарегистрированные клиенты</a></li>
                <li class="bg_lg span3"><a href="payment.php" style="font-size: 16px;"> <i
                                class="fa fa-dollar-sign"></i> Общий доход: ₽ <?php include 'income-count.php' ?></a>
                </li>
                <li class="bg_lb span2"><a href="announcement.php" style="font-size: 16px;"> <i
                                class="fas fa-bullhorn"></i><span
                                class="label label-important"><?php include 'actions/count-announcements.php' ?></span>
                        Объявления</a></li>
            </ul>
        <!--End-Action boxes-->
                        ...
                        <div class="span4">
                            <ul class="site-stats">
                                <li class="bg_lh"><i class="fas fa-users"></i>
                                    <strong><?php include 'dashboard-usercount.php'; ?></strong> <small>Всего клиентов</small></li>
                                <li class="bg_lg"><i class="fas fa-user-clock"></i>
                                    <strong><?php include 'actions/dashboard-staff-count.php'; ?></strong> <small>Сотрудники</small></li>
                                <li class="bg_ls"><i class="fas fa-dumbbell"></i>
                                    <strong><?php include 'actions/count-equipments.php'; ?></strong> <small>Доступный спортинвентарь</small></li>
                                <li class="bg_ly"><i class="fas fa-file-invoice-dollar"></i>
                                    <strong>₽ <?php include 'actions/total-exp.php'; ?></strong> <small>Суммарные расходы</small></li>
                                <li class="bg_lr"><i class="fas fa-user-ninja"></i>
                                    <strong><?php include 'actions/count-trainers.php'; ?></strong> <small>Действующие тренеры</small></li>
                                <li class="bg_lb"><i class="fas fa-calendar-check"></i>
                                    <strong><?php include 'actions/count-attendance.php'; ?></strong> <small>Присутствующие клиенты</small></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="row-fluid">
            <div class="widget-box">
                <div class="widget-title bg_lg"><span class="icon"><i class="fas fa-file"></i></span>
                    <h5>Отчёты о доходах и расходах</h5>
                </div>
                <div class="widget-content">
                    <div class="row-fluid">
                        <div class="span12">
        ...
        <div class="row-fluid">
            <div class="span6">
                <div class="widget-box">
                    <div class="widget-title bg_ly" data-toggle="collapse" href="#collapseG2"><span class="icon"><i
                        ...
                        <h5>Зарегистрированные посетители спорткоплекса по полу: обзор</h5>
                    </div>
            ...
            <div class="span6">
                <div class="widget-box">
                    <div class="widget-title bg_ly" data-toggle="collapse" href="#collapseG2"><span class="icon"><i
                                    class="fas fa-chevron-down"></i></span>
                        <h5>Персонал по должностям: обзор</h5>
                    </div>
                    <div class="widget-content nopadding collapse in" id="collapseG2">
                        <ul class="recent-posts">
                            ...
                            <ul>
                                ...
                                <li class='clearfix'>
                                    ...
                                    <div class='txt'> <?php echo $row["task_desc"] ?><?php if ($row["task_status"] == "Pending") {
                                            echo '<span class="by label label-info">В ожидании</span>';
                                        } else {
                                            echo '<span class="by label label-success">В процессе</span>';
                                        } ?></div>

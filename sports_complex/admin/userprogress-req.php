...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Главная страница</a> <a href="customer-progress.php" class="tip-bottom">Прогресс клиентов</a> <a href="update-progress.php" class="current">Обновление прогресса</a> </div>
  <h1 class="text-center">Обновление прогресса клиента <i class="fas fa-signal"></i></h1>
</div>
                ...
                echo"<div class='container-fluid'>";
                    ...
                    echo"<div class='widget-title'> <span class='icon'> <i class='fas fa-info'></i> </span>";
                        ...
                        echo"<div class='widget-content'>";
                            ...
                            echo"<a class='btn btn-warning btn-big'  href='customer-progress.php'>Назад</a> </div>";
                        echo"</div>";
                        echo"</div>";
                    echo"</div>";
                    echo"</div>";
                ...
                echo"<div class='container-fluid'>";
                    ...
                    echo"<div class='widget-title'> <span class='icon'> <i class='fas fa-briefcase'></i> </span>";
                        ...
                        echo"<div class='widget-content'>";
                            echo"<div class='error_ex'>";
                            echo"<h1>Успех</h1>";
                            echo"<h3>Изменения успешно сохранены!</h3>";
                            echo"<p>Прогресс запрошенного пользователя был обновлен. Пожалуйста, нажмите кнопку, чтобы вернуться назад.</p>";
                            echo"<a class='btn btn-inverse btn-big'  href='customer-progress.php'>Назад</a> </div>";
                        echo"</div>";
                        echo"</div>";
                    echo"</div>";
                    echo"</div>";

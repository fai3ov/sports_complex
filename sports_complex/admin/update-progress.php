...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Главная страница</a> <a href="customer-progress.php">Прогресс клиентов</a> <a href="update-progress.php" class="current">Обновление прогресса</a> </div>
          ...
          <div class="widget-content">
            ...
            <div class="row-fluid">
             ...
             <input type="hidden" name="id" value="<?php echo $row['user_id'];?>">
                  <button class="btn btn-primary btn-large" type="SUBMIT" href="">Сохранить изменения</button>
				</div>

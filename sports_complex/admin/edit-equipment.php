...
<div id="content">
  <div id="content-header">
    ...
    <h1 class="text-center">Обновление информации о спортинвентаре <i class="fas fa-cogs"></i></h1>
  </div>
        ...
        $result=mysqli_query($conn,$qry);
          ...
          echo"<table class='table table-bordered table-hover'>
            ...
            echo"<tbody> 
                ...
                <td><div class='text-center'><a href='edit-equipmentform.php?id=".$row['id']."'><i class='fas fa-edit'></i> Редактировать</a></div></td>

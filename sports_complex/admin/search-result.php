...
<!--Header-part-->
<div id="header">
  <h1><a href="">Sports Complex Admin</a></h1>
</div>
<!--close-Header-part-->
...
<div id="content">
  <div id="content-header">
      <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Главная страница</a> <a href="payment.php" class="current">Платежи от клиентов</a> </div>
      <h1 class="text-center">Платежи от зарегистрированных клиентов <i class="fas fa-group"></i></h1>
  </div>
    ...
    <div class="row-fluid">
      ...
      $cnt = 1;
        ...
        if (mysqli_num_rows($result)==0){
            ...
            <h1>403</h1>
            <h3>Упс, результаты не найдены!</h3>
            <p>Похоже, в нашей базе данных такой записи нет.</p>
            <a class='btn btn-danger btn-big'  href='payment.php'>Назад</a> </div>'";
        }else{
        ...
        <thead>
          <tr>
            ...
            echo"<tbody> 
                ...
                <td><div class='text-center'><a href='user-payment.php?id=".$row['user_id']."'><button class='btn btn-success btn'><i class='fas fa-dollar-sign'></i> Произвести оплату</button></a></div></td>

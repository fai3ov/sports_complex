...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Главная страница</a> <a href="equipment.php" class="current">Список спортинвентаря</a> </div>
    <h1 class="text-center">Список спортинвентаря <i class="fas fa-cogs"></i></h1>
  </div>

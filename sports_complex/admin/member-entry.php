...
<div id="content-header">
    <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Главная страница</a> <a href="members.php" class="tip-bottom">Клиенты спорткомплекса</a> <a href="member-entry.php" class="current">Добавление клиента</a> </div>
        ...
        <div class="widget-content nopadding">
          <form action="add-member-req.php" method="POST" class="form-horizontal" id="memberForm">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" name="username" placeholder="Имя пользователя" required />
              </div>
            </div>
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <span class="help-block">Примечание: данная информация будет использована для создания аккаунта клиента.</span>
              </div>
            </div>
            <div class="control-group">
        ...
        <div class="widget-content nopadding">
          <div class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" name="address" placeholder="Адрес" required />
              </div>
            </div>
          </div>
        ...
        <div class="widget-content nopadding">
          <div class="form-horizontal">
            ...
            <div class="form-actions text-center">
              <button type="submit" class="btn btn-success">Подтвердить информацию о клиенте</button>
            </div>

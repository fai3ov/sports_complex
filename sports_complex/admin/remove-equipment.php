...
<div id="content">
  <div id="content-header">
      <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Главная страница</a> <a href="equipment.php" class="tip-bottom">Спортинвентарь</a> <a href="remove-equipment.php" class="current">Удаление спортинвентаря</a> </div>
    <h1 class="text-center">Удаление спортинвентаря <i class="fas fa-cogs"></i></h1>
  </div>
        ...
        $result=mysqli_query($conn,$qry);
          ...
          echo"<table class='table table-bordered table-hover'>
            ...
            echo"<tbody> 
                ...
                <td><div class='text-center'><a href='actions/delete-equipment.php?id=".$row['id']."' style='color:#F66;'><i class='fas fa-trash'></i> Удалить</a></div></td>

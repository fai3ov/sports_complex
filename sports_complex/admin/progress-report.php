...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Главная страница</a> <a href="progress-report.php" class="current">Отчёты о прогрессе клиентов</a> </div>
    <h1 class="text-center">Отчёты о прогрессе клиентов <i class="fas fa-signal"></i></h1>
  </div>
        ...
        $result=mysqli_query($conn,$qry);
          ...
          echo"<table class='table table-bordered table-hover'>
           ...
           <tbody> 
                ...
                <td><div class='text-center'><a href="view-progress-report.php?id= <?php echo $row['user_id'] ?>"><i class="fas fa-file"></i> Посмотреть отчёт о прогрессе</a></div></td>

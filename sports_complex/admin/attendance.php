...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Главная страница</a> <a href="attendance.php" class="current">Регистрация прихода/ухода</a> </div>
        <h1 class="text-center">Регистрация прихода/ухода <i class="fas fa-calendar"></i></h1>
    </div>

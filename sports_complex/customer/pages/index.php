...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Вы уже находитесь здесь!" class="tip-bottom"><i class="icon-home"></i> Главная страница</a></div>
  </div>
<!--End-breadcrumbs-->
            ...
            echo"<table class='table table-striped table-bordered'>
              ...
              echo"<tbody>
                <tr>
                  ...
                  <td class='taskStatus'>" . ($row["task_status"] == "Pending" ? '<span class="label label-info">В ожидании</span>' : '<span class="label label-success">В процессе</span>') . "</td>
                  <td class='taskOptions'><a href='update-todo.php?id=".$row['id']."' class='tip-top' data-original-title='Изменить'><i class='icon-edit'></i></a>  <a href='actions/remove-todo.php?id=".$row['id']."' class='tip-top' data-original-title='Выполнено'><i class='icon-ok'></i></a></td>
                </tr>
              </tbody>";
              }
        ?>
          ...
          <div class="widget-content nopadding collapse in" id="collapseG2">
            <ul class="recent-posts">
              ...
              <?php
                ...
                echo"</li>";
              ?>
                <a href="announcement.php"><button class="btn btn-warning btn-mini">Посмотреть все</button></a>
              </li>
            </ul>
          </div>
        </div>

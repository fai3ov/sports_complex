...
<!--breadcrumbs-->
    <div id="content-header">
        <div id="breadcrumb"> <a href="index.php" title="Перейти на главную страницу" class="tip-bottom"><i class="icon-home"></i> Главная страница</a> <a href="customer-reminder.php" class="current">Напоминания</a> </div>
    </div>
<!--End-breadcrumbs-->
        ...
        $result=mysqli_query($con,$qry);
            while($row=mysqli_fetch_array($result)){ ?>
              <?php if($row['reminder'] == '1') { ?>
                ...
                <p>Срок действия Вашего текущего абонемента скоро истечёт. Пожалуйста, внесите платёж до истечения срока оплаты. <br>ВАЖНО ВОВРЕМЯ ПОГАСИТЬ ВСЕ ЗАДОЛЖЕННОСТИ, ЧТОБЫ ИЗБЕЖАТЬ ПРЕРЫВАНИЯ УСЛУГ.</p>
                <hr>

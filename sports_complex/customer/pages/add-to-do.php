            ...
            echo"<div class='container-fluid'>";
                ...
                echo"<div class='widget-title'> <span class='icon'> <i class='icon-info-sign'></i> </span>";
                    ...
                    echo"<div class='widget-content'>";
                        ...
                        echo"<a class='btn btn-warning btn-big'  href='to-do.php'>Назад</a> </div>";
                    echo"</div>";
                    echo"</div>";
                echo"</div>";
                echo"</div>";
            ...
            echo"<div class='container-fluid'>";
                ...
                echo"<div class='widget-title'> <span class='icon'> <i class='icon-info-sign'></i> </span>";
                    ...
                    echo"<div class='widget-content'>";
                        echo"<div class='error_ex'>";
                        echo"<h1>Успех</h1>";
                        echo"<h3>Задача добавлена!</h3>";
                        echo"<p>Пожалуйста, нажмите кнопку, чтобы вернуться назад.</p>";
                        echo"<a class='btn btn-inverse btn-big'  href='to-do.php'>Назад</a> </div>";
                    echo"</div>";
                    echo"</div>";
                echo"</div>";
                echo"</div>";

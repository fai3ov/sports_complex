...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Главная страница</a> <a href="member-status.php" class="current">Статус клиентов</a> </div>
        <h1 class="text-center">Текущий статус клиентов <i class="icon icon-eye-open"></i></h1>
    </div>

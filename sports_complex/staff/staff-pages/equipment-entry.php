...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Главная страница</a> <a href="equipment.php" class="tip-bottom">Спортинвентарь</a> <a href="equipment-entry.php" class="current">Добавление спортинвентаря</a> </div>
                    ...
                    <div class="widget-content nopadding">
                        <form action="add-equipment-req.php" method="POST" class="form-horizontal">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span11" name="ename" placeholder="Название спортинвентаря" required />
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">Описание :</label>
                                <div class="controls">
                                    <input type="text" class="span11" name="description" placeholder="Краткое описание" required />
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="number" class="span5" name="quantity" placeholder="Кол-во" required />
                                </div>
                            </div>
                    ...
                    <div class="widget-content nopadding">
                        <div class="form-horizontal">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span11" name="vendor" placeholder="Продавец"required />
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span11" name="address" placeholder="Адрес продавца" required />
                                </div>
                            </div>
                        ...
                        <div class="widget-content nopadding">
                            <div class="form-horizontal">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <div class="input-append">
                                            ...
                                            <input type="number" placeholder="10000" name="amount" class="span11" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-actions text-center">
                                    <button type="submit" class="btn btn-success">Подвердить информацию</button>
                                </div>
                                </form>
                            </div>
                        </div>

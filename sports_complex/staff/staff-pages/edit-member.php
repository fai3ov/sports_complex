...
<div id="content">
    <div id="content-header">
        ...
        <h1 class="text-center">Обновление данных клиентов <i class="icon icon-group"></i></h1>
    </div>
        ...
        <div class="row-fluid">
            <div class="span12">
              ...
              <thead>
                ...
                <td><div class='text-center'><a href='edit-memberform.php?id=" . $row['user_id'] . "'><i class='icon icon-pencil'></i> Редактировать</a></div></td>

...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Главная страница</a> <a href="equipment.php" class="tip-bottom">Спортинвентарь</a> <a href="remove-equipment.php" class="current">Удаление спортинвентаря</a> </div>
        <h1 class="text-center">Удаление спортинвентаря <i class="icon icon-cogs"></i></h1>
    </div>
        ...
        <div class="row-fluid">
            <div class="span12">
              ...
              <thead>
                ...
                <td><div class='text-center'><a href='actions/delete-equipment.php?id=".$row['id']."' style='color:#F66;'><i class='icon icon-trash'></i> Удалить</a></div></td>

...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Главная страница</a> <a href="equipment.php" class="tip-bottom">Спортинвентарь</a> <a href="edit-equipment.php" class="current">Обновление информации о спортинвентаре</a> </div>
        <h1 class="text-center">Обновление информации о спортинвентаре <i class="icon icon-cogs"></i></h1>
    </div>
        ...
        <div class="row-fluid">
            <div class="span12">
              ...
              <thead>
                <tr>
                  <th>#</th>
                  <th>Название спортинвентаря</th>
                  <th>Описание спортинвентаря</th>
                  <th>Количество</th>
                  <th>Сумма</th>
                  <th>Продавец</th>
                ...
                <td><div class='text-center'><a href='edit-equipmentform.php?id=".$row['id']."'><i class='icon icon-pencil'></i> Редактировать</a></div></td>

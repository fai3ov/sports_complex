...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Главная страница</a> <a href="members.php" class="tip-bottom">Клиенты спорткомплекса</a> <a href="remove-member.php" class="current">Удаление клиентов</a> </div>
        <h1 class="text-center">Удаление клиентов <i class="icon icon-group"></i></h1>
    </div>
        ...
        <div class="row-fluid">
            <div class="span12">
              ...
              <thead>
                ...
                <td><div class='text-center'><a href='actions/delete-member.php?id=".$row['user_id']."' style='color:#F66;'><i class='icon icon-trash'></i> Удалить</a></div></td>

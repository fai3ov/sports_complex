...
<div id="content">
  <div id="content-header">
      <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Главная страница</a> <a href="payment.php" class="current">Платежи от клиентов</a> </div>
    <h1 class="text-center">Платежи от зарегистрированных клиентов <i class="icon icon-group"></i></h1>
  </div>
        ...
        <thead>
          <tr>
            ...
            echo"<tbody> 
                ...
                <td><div class='text-center'><a href='user-payment.php?id=".$row['user_id']."'><button class='btn btn-success btn'><i class='icon icon-money'></i> Произвести оплату</button></a></div></td>
